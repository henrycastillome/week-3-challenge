...
for day_week in schedule:
	for classroom in schedule[day_week]:
		for classes in schedule[day_week][classroom]:
			print(day_week,"-->","\t", classroom,"-->","\t", classes)
	

#loop through each day and then each room and then each class and print it out
